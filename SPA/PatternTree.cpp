...
PatternTree::~PatternTree(void)
{
}

void PatternTree::iterateAndStore(RELATION_LIST *result, RELATION_LIST list){
	if(list.empty()){
			result=NULL;
		}else{
...
RELATION_LIST* PatternTree::evaluatePatternTree(QTREE* patternTree,QUERYTABLE* qrTable){
	this->patternTree = patternTree;
	this->qrTable = qrTable;
}
RELATION_LIST* PatternTree::evaluatePattern(){
	
	QTREE * currentNode;
	currentNode = patternTree->getFirstDescendant();
	TYPE relType;
	QTREE * firstRel;
	QTREE * secondRel;
